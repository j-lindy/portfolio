...
new ScrollMagic.Scene({triggerElement: "#trgr-mission-section", duration: (windowHeight*1)})
...
new ScrollMagic.Scene({triggerElement: "#trgr-journey-section", duration: (windowHeight*5)})
// animate color and top border in relation to scroll position
...
new ScrollMagic.Scene({triggerElement: "#trgr-unity-section", duration: (windowHeight*20)})
// animate color and top border in relation to scroll position
...
// Ranch Portrait Movement

new ScrollMagic.Scene({triggerElement: "#trgr-history-image", duration: (windowHeight*1)})
// animate color and top border in relation to scroll position
.setTween("#ranch-portrait", {marginTop: "-30vmin"}) // the tween durtion can be omitted and defaults to 1
.addIndicators({name: "Ranch Portrait"}) // add indicators (requires plugin)
.addTo(controller);
...
new ScrollMagic.Scene({ triggerElement: "#trgr-sling-h1-text-in", duration: 0})
//new ScrollMagic.Scene({ triggerElement: '#trgr1', trgrHook: 'onEnter' })
.on('enter', function () {
$('#sling-h1-text').addClass('text-in');
$('#sling-h1-text').removeClass('text-start');
})
.on('leave', function () {
$('#sling-h1-text').addClass('text-start');
$('#sling-h1-text').removeClass('text-in');
})
.addIndicators({name: "sling H1 Text"}) // add indicators (requires plugin)
.addTo(controller);

new ScrollMagic.Scene({ triggerElement: "#trgr-sling-h1-text-out", duration: 0})
//new ScrollMagic.Scene({ triggerElement: '#trgr1', trgrHook: 'onEnter' })
.on('enter', function () {
$('#sling-h1-text').addClass('text-out blur');
$('#sling-h1-text').removeClass('text-in no-blur');
})
.on('leave', function () {
$('#sling-h1-text').addClass('text-in no-blur');
$('#sling-h1-text').removeClass('text-out blur');
})
.addIndicators({name: "sling H1 Text Out"}) // add indicators (requires plugin)
.addTo(controller);
...
new ScrollMagic.Scene({ triggerElement: "#trgr-sling-h1-ul", duration: 0})
//new ScrollMagic.Scene({ triggerElement: '#trgr1', trgrHook: 'onEnter' })
.on('enter', function () {
$('#sling-h1-ul').addClass('underline0-in');
$('#sling-h1-ul').removeClass('underline0-out');
})
.on('leave', function () {
$('#sling-h1-ul').addClass('underline0-out');
$('#sling-h1-ul').removeClass('underline0-in');
})
.addIndicators({name: "sling H1 Red"}) // add indicators (requires plugin)
.addTo(controller);

new ScrollMagic.Scene({ triggerElement: "#trgr-sling-h1-ul-m", duration: 0})
//new ScrollMagic.Scene({ triggerElement: '#trgr1', trgrHook: 'onEnter' })
.on('enter', function () {
$('#sling-h1-ul-m').addClass('underline0-in');
$('#sling-h1-ul-m').removeClass('underline0-out');
})
.on('leave', function () {
$('#sling-h1-ul-m').addClass('underline0-out');
$('#sling-h1-ul-m').removeClass('underline0-in');
})
.addIndicators({name: "sling H1 Underline-m"}) // add indicators (requires plugin)
.addTo(controller);
